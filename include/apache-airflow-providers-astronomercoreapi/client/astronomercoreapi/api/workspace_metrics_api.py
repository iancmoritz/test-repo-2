...
class WorkspaceMetricsApi(object):
    ...
    @validate_arguments
    def get_workspace_dag_runs(self, organization_id : Annotated[StrictStr, Field(..., description="organization ID")], workspace_id : Annotated[StrictStr, Field(..., description="ID that defines the workspace")], range : Annotated[conint(strict=True, ge=1800), Field(..., description="range of the DAG runs metrics in seconds")], step : Annotated[conint(strict=True, ge=60), Field(..., description="step interval of the DAG runs metrics in seconds")], deployment_ids : Annotated[Optional[StrictStr], Field(description="IDs that define the deployments, separated by comma")] = None, virtual_runtime_ids : Annotated[Optional[StrictStr], Field(description="IDs that define the virtual runtimes, separated by comma")] = None, runtime_type : Annotated[Optional[StrictStr], Field(description="type of runtime")] = None, status : Annotated[Optional[StrictStr], Field(description="status of dag runs")] = None, **kwargs) -> List[WorkspaceRangeMetricPerStatus]:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the get_workspace_dag_runs_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.get_workspace_dag_runs_with_http_info(organization_id, workspace_id, range, step, deployment_ids, virtual_runtime_ids, runtime_type, status, **kwargs)  # noqa: E501

    @validate_arguments
    def get_workspace_dag_runs_with_http_info(self, organization_id : Annotated[StrictStr, Field(..., description="organization ID")], workspace_id : Annotated[StrictStr, Field(..., description="ID that defines the workspace")], range : Annotated[conint(strict=True, ge=1800), Field(..., description="range of the DAG runs metrics in seconds")], step : Annotated[conint(strict=True, ge=60), Field(..., description="step interval of the DAG runs metrics in seconds")], deployment_ids : Annotated[Optional[StrictStr], Field(description="IDs that define the deployments, separated by comma")] = None, virtual_runtime_ids : Annotated[Optional[StrictStr], Field(description="IDs that define the virtual runtimes, separated by comma")] = None, runtime_type : Annotated[Optional[StrictStr], Field(description="type of runtime")] = None, status : Annotated[Optional[StrictStr], Field(description="status of dag runs")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Get DAG runs metrics for a workspace  # noqa: E501
        ...
        return self.api_client.call_api(
            '/organizations/{organizationId}/workspaces/{workspaceId}/metrics/dag-runs-per-status', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def get_workspace_task_runs(self, organization_id : Annotated[StrictStr, Field(..., description="organization ID")], workspace_id : Annotated[StrictStr, Field(..., description="ID that defines the workspace")], range : Annotated[conint(strict=True, ge=1800), Field(..., description="range of the task runs metric in seconds")], step : Annotated[conint(strict=True, ge=60), Field(..., description="step interval of task runs metric in seconds")], deployment_ids : Annotated[Optional[StrictStr], Field(description="IDs that define the deployments, separated by comma")] = None, virtual_runtime_ids : Annotated[Optional[StrictStr], Field(description="IDs that define the virtual runtimes, separated by comma")] = None, runtime_type : Annotated[Optional[StrictStr], Field(description="type of runtime")] = None, status : Annotated[Optional[StrictStr], Field(description="status of task runs")] = None, include_deleted_deployments : Annotated[Optional[StrictBool], Field(description="results should include data from soft deleted deployments")] = None, **kwargs) -> List[WorkspaceRangeMetricPerStatus]:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the get_workspace_task_runs_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
        return self.get_workspace_task_runs_with_http_info(organization_id, workspace_id, range, step, deployment_ids, virtual_runtime_ids, runtime_type, status, include_deleted_deployments, **kwargs)  # noqa: E501

    @validate_arguments
    def get_workspace_task_runs_with_http_info(self, organization_id : Annotated[StrictStr, Field(..., description="organization ID")], workspace_id : Annotated[StrictStr, Field(..., description="ID that defines the workspace")], range : Annotated[conint(strict=True, ge=1800), Field(..., description="range of the task runs metric in seconds")], step : Annotated[conint(strict=True, ge=60), Field(..., description="step interval of task runs metric in seconds")], deployment_ids : Annotated[Optional[StrictStr], Field(description="IDs that define the deployments, separated by comma")] = None, virtual_runtime_ids : Annotated[Optional[StrictStr], Field(description="IDs that define the virtual runtimes, separated by comma")] = None, runtime_type : Annotated[Optional[StrictStr], Field(description="type of runtime")] = None, status : Annotated[Optional[StrictStr], Field(description="status of task runs")] = None, include_deleted_deployments : Annotated[Optional[StrictBool], Field(description="results should include data from soft deleted deployments")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Get task runs metrics for a workspace  # noqa: E501
        ...
        return self.api_client.call_api(
            '/organizations/{organizationId}/workspaces/{workspaceId}/metrics/task-runs-per-status', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
