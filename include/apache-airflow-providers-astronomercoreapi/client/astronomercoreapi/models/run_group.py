...
class RunGroup(BaseModel):
    ...
    __properties = ["children", "extraLinks", "hasOutletDatasets", "id", "isMapped", "label", "operator", "taskInstances"]
    ...
    def from_dict(cls, obj: dict) -> RunGroup:
        ...
        _obj = RunGroup.parse_obj({
            "children": [RunGroup.from_dict(_item) for _item in obj.get("children")] if obj.get("children") is not None else None,
