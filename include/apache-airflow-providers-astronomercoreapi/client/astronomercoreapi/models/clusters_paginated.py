...
class ClustersPaginated(BaseModel):
    """
    ClustersPaginated
    """
    clusters: conlist(Cluster) = Field(...)
    limit: StrictInt = Field(...)
    offset: StrictInt = Field(...)
    total_count: StrictInt = Field(..., alias="totalCount")
    __properties = ["clusters", "limit", "offset", "totalCount"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClustersPaginated:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClustersPaginated:
        """Create an instance of ClustersPaginated from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClustersPaginated.parse_obj(obj)

        _obj = ClustersPaginated.parse_obj({
            "clusters": [Cluster.from_dict(_item) for _item in obj.get("clusters")] if obj.get("clusters") is not None else None,
            "limit": obj.get("limit"),
