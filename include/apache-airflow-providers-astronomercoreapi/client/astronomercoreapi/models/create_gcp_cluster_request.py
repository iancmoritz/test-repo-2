...
class CreateGcpClusterRequest(BaseModel):
    ...
    __properties = ["dbInstanceType", "isDryRun", "k8sTags", "name", "nodePools", "podSubnetRange", "providerAccount", "region", "servicePeeringRange", "serviceSubnetRange", "templateVersion", "type", "vpcSubnetRange"]
