...
class WorkerQueueOptions(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> WorkerQueueOptions:
        ...
        _obj = WorkerQueueOptions.parse_obj({
            "max_workers": ResourceRange.from_dict(obj.get("maxWorkers")) if obj.get("maxWorkers") is not None else None,
            "min_workers": ResourceRange.from_dict(obj.get("minWorkers")) if obj.get("minWorkers") is not None else None
        })
        return _obj
