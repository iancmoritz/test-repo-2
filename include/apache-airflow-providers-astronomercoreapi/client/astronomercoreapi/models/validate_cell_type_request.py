...
class ValidateCellTypeRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ValidateCellTypeRequest:
        ...
        _obj = ValidateCellTypeRequest.parse_obj({
            "behavior": CtmBehavior.from_dict(obj.get("behavior")) if obj.get("behavior") is not None else None,
            "configs": [CtmConfig.from_dict(_item) for _item in obj.get("configs")] if obj.get("configs") is not None else None,
            "display": CtmDisplay.from_dict(obj.get("display")) if obj.get("display") is not None else None,
            "generation": CtmGeneration.from_dict(obj.get("generation")) if obj.get("generation") is not None else None,
            "name": obj.get("name")
        })
        return _obj
