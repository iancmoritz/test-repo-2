...
class Team(BaseModel):
    ...
    __properties = ["createdAt", "createdBy", "description", "id", "isIdpManaged", "members", "membersCount", "name", "organizationId", "organizationRole", "roles", "rolesCount", "updatedAt", "updatedBy"]
    ...
    def from_dict(cls, obj: dict) -> Team:
        ...
        _obj = Team.parse_obj({
            ...
            "members": [TeamMember.from_dict(_item) for _item in obj.get("members")] if obj.get("members") is not None else None,
            "members_count": obj.get("membersCount"),
            "name": obj.get("name"),
            "organization_id": obj.get("organizationId"),
            "organization_role": obj.get("organizationRole"),
            "roles": [TeamRole.from_dict(_item) for _item in obj.get("roles")] if obj.get("roles") is not None else None,
