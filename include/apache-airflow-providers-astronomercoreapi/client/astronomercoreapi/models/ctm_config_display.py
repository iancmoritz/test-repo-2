...
class CtmConfigDisplay(BaseModel):
    ...
    __properties = ["default", "description", "example", "fixedWidthFont", "highlightLanguage", "label", "numLines", "rawType"]
    ...
    def from_dict(cls, obj: dict) -> CtmConfigDisplay:
        ...
        _obj = CtmConfigDisplay.parse_obj({
            "default": CtmValue.from_dict(obj.get("default")) if obj.get("default") is not None else None,
            "description": obj.get("description"),
            "example": CtmValue.from_dict(obj.get("example")) if obj.get("example") is not None else None,
