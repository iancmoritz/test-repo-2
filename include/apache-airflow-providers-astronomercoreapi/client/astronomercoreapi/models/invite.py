...
class Invite(BaseModel):
    ...
    org_name: Optional[StrictStr] = Field(None, alias="orgName", description="Deprecated: orgName has been replaced with organizationName")
    ...
    __properties = ["expiresAt", "inviteId", "invitee", "inviter", "oAuthInviteId", "orgName", "orgShortName", "organizationId", "organizationName", "organizationShortName", "ticketId", "userId"]
    ...
    def from_dict(cls, obj: dict) -> Invite:
        ...
        _obj = Invite.parse_obj({
            ...
            "invitee": BasicSubjectProfile.from_dict(obj.get("invitee")) if obj.get("invitee") is not None else None,
            "inviter": BasicSubjectProfile.from_dict(obj.get("inviter")) if obj.get("inviter") is not None else None,
