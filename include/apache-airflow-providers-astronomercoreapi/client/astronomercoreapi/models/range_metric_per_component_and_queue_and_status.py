...
class RangeMetricPerComponentAndQueueAndStatus(BaseModel):
    """
    ...
    __properties = ["component", "deploymentId", "end", "queue", "releaseName", "start", "status", "step", "values", "workspaceId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RangeMetricPerComponentAndQueueAndStatus:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RangeMetricPerComponentAndQueueAndStatus:
        """Create an instance of RangeMetricPerComponentAndQueueAndStatus from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RangeMetricPerComponentAndQueueAndStatus.parse_obj(obj)

        _obj = RangeMetricPerComponentAndQueueAndStatus.parse_obj({
