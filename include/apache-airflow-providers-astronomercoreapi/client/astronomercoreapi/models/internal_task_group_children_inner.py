...
class InternalTaskGroupChildrenInner(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> InternalTaskGroupChildrenInner:
        ...
        _obj = InternalTaskGroupChildrenInner.parse_obj({
            "task": InternalTask.from_dict(obj.get("task")) if obj.get("task") is not None else None,
            "task_group": InternalTaskGroup.from_dict(obj.get("taskGroup")) if obj.get("taskGroup") is not None else None
        })
        return _obj
