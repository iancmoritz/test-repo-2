...
class Cell(BaseModel):
    ...
    __properties = ["cache", "createdAt", "createdBy", "dependenciesExplicit", "id", "name", "organizationId", "pipelineId", "projectId", "type", "typeConfigForms", "typeConfigs", "typeNotFound", "updatedAt", "updatedBy", "workspaceId"]
    ...
    def from_dict(cls, obj: dict) -> Cell:
        ...
        _obj = Cell.parse_obj({
            "cache": CellCache.from_dict(obj.get("cache")) if obj.get("cache") is not None else None,
