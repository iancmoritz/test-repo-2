...
class PostLoginEvent(BaseModel):
    ...
    __properties = ["client", "connection", "organization", "request", "transaction", "user"]
    ...
    def from_dict(cls, obj: dict) -> PostLoginEvent:
        ...
        _obj = PostLoginEvent.parse_obj({
            "client": EventClient.from_dict(obj.get("client")) if obj.get("client") is not None else None,
            "connection": EventConnection.from_dict(obj.get("connection")) if obj.get("connection") is not None else None,
            "organization": EventOrganization.from_dict(obj.get("organization")) if obj.get("organization") is not None else None,
            "request": EventRequest.from_dict(obj.get("request")) if obj.get("request") is not None else None,
            "transaction": obj.get("transaction"),
            "user": EventUser.from_dict(obj.get("user")) if obj.get("user") is not None else None
        })
        return _obj
