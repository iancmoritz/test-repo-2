...
class RangeMetric(BaseModel):
    ...
    __properties = ["deploymentId", "deploymentName", "end", "releaseName", "start", "step", "values", "workspaceId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RangeMetric:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RangeMetric:
        """Create an instance of RangeMetric from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RangeMetric.parse_obj(obj)

        _obj = RangeMetric.parse_obj({
