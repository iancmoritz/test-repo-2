...
class WorkspaceRangeMetricPerStatus(BaseModel):
    """
    ...
    __properties = ["end", "start", "status", "step", "values", "workspaceId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WorkspaceRangeMetricPerStatus:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WorkspaceRangeMetricPerStatus:
        """Create an instance of WorkspaceRangeMetricPerStatus from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WorkspaceRangeMetricPerStatus.parse_obj(obj)

        _obj = WorkspaceRangeMetricPerStatus.parse_obj({
            "end": obj.get("end"),
            "start": obj.get("start"),
