...
class Project(BaseModel):
    ...
    requirement_dependencies: Optional[Dict[str, conlist(StrictStr)]] = Field(None, alias="requirementDependencies")
    ...
    __properties = ["connections", "createdAt", "createdBy", "description", "git", "id", "includes", "name", "organizationId", "pipelineCount", "requirementDependencies", "requirements", "updatedAt", "updatedBy", "variables", "workspaceId"]
    ...
    def from_dict(cls, obj: dict) -> Project:
        ...
        _obj = Project.parse_obj({
            "connections": [ProjectConnection.from_dict(_item) for _item in obj.get("connections")] if obj.get("connections") is not None else None,
            "created_at": obj.get("createdAt"),
            "created_by": obj.get("createdBy"),
            "description": obj.get("description"),
            "git": ProjectGit.from_dict(obj.get("git")) if obj.get("git") is not None else None,
            "id": obj.get("id"),
            "includes": [ProjectInclude.from_dict(_item) for _item in obj.get("includes")] if obj.get("includes") is not None else None,
            "name": obj.get("name"),
            ...
            "variables": [ProjectVariable.from_dict(_item) for _item in obj.get("variables")] if obj.get("variables") is not None else None,
