...
class RangeMetricPerStatus(BaseModel):
    """
    ...
    __properties = ["deploymentId", "end", "releaseName", "start", "status", "step", "values", "workspaceId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RangeMetricPerStatus:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RangeMetricPerStatus:
        """Create an instance of RangeMetricPerStatus from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RangeMetricPerStatus.parse_obj(obj)

        _obj = RangeMetricPerStatus.parse_obj({
