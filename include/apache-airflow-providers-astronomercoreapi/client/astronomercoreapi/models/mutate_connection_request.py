...
class MutateConnectionRequest(BaseModel):
    """
    ...
    __properties = ["connectionName", "extra", "host", "login", "password", "port", "schema", "type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MutateConnectionRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MutateConnectionRequest:
        """Create an instance of MutateConnectionRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MutateConnectionRequest.parse_obj(obj)

        _obj = MutateConnectionRequest.parse_obj({
