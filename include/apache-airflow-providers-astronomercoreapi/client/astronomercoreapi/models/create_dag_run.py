...
class CreateDagRun(BaseModel):
    ...
    external_trigger: StrictBool = Field(..., alias="externalTrigger")
    logical_date: datetime = Field(..., alias="logicalDate")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateDagRun:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateDagRun:
        """Create an instance of CreateDagRun from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateDagRun.parse_obj(obj)

        _obj = CreateDagRun.parse_obj({
            "conf": obj.get("conf"),
