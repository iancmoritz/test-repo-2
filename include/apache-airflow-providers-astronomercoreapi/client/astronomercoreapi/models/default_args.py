...
class DefaultArgs(BaseModel):
    ...
    execution_timeout_seconds: Optional[StrictInt] = Field(None, alias="executionTimeoutSeconds")
    max_retry_delay_seconds: Optional[StrictInt] = Field(None, alias="maxRetryDelaySeconds")
    queue: Optional[StrictStr] = None
    retries: Optional[StrictInt] = None
    retry_delay_seconds: Optional[StrictInt] = Field(None, alias="retryDelaySeconds")
    retry_exponential_backoff: Optional[StrictBool] = Field(None, alias="retryExponentialBackoff")
    sla_seconds: Optional[StrictInt] = Field(None, alias="slaSeconds")
    task_concurrency: Optional[StrictInt] = Field(None, alias="taskConcurrency")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DefaultArgs:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DefaultArgs:
        """Create an instance of DefaultArgs from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DefaultArgs.parse_obj(obj)

        _obj = DefaultArgs.parse_obj({
