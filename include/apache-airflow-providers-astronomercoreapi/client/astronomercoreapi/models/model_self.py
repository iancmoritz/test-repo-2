...
class ModelSelf(BaseModel):
    ...
    __properties = ["avatarUrl", "colorModePreference", "createdAt", "featureFlags", "fullName", "id", "intercomUserHash", "invites", "organizationId", "roles", "status", "systemRole", "updatedAt", "username"]
    ...
    def from_dict(cls, obj: dict) -> ModelSelf:
        ...
        _obj = ModelSelf.parse_obj({
            ...
            "feature_flags": [FeatureFlag.from_dict(_item) for _item in obj.get("featureFlags")] if obj.get("featureFlags") is not None else None,
