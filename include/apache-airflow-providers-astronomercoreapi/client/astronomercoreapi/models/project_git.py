...
class ProjectGit(BaseModel):
    ...
    git_vendor_attributes: Optional[ProjectGitVendorAttributes] = Field(None, alias="gitVendorAttributes")
    repo: Optional[StrictStr] = None
    token_set: Optional[StrictBool] = Field(None, alias="tokenSet")
    vendor: Optional[StrictStr] = None
    __properties = ["branch", "dagsPath", "gitVendorAttributes", "repo", "tokenSet", "vendor"]
    ...
    def from_dict(cls, obj: dict) -> ProjectGit:
        ...
        _obj = ProjectGit.parse_obj({
            ...
            "git_vendor_attributes": ProjectGitVendorAttributes.from_dict(obj.get("gitVendorAttributes")) if obj.get("gitVendorAttributes") is not None else None,
            "repo": obj.get("repo"),
