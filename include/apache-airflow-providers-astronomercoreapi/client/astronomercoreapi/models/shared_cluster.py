...
class SharedCluster(BaseModel):
    ...
    __properties = ["cloudProvider", "createdAt", "dbInstanceType", "id", "isCordoned", "isDryRun", "metadata", "name", "podSubnetRange", "region", "servicePeeringRange", "serviceSubnetRange", "status", "templateVersion", "updatedAt", "vpcSubnetRange"]
