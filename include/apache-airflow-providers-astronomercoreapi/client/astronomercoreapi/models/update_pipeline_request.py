...
class UpdatePipelineRequest(BaseModel):
    ...
    dag_run_timeout_seconds: Optional[conint(strict=True, ge=0)] = Field(None, alias="dagRunTimeoutSeconds")
    ...
    max_active_runs: Optional[conint(strict=True, ge=0)] = Field(None, alias="maxActiveRuns")
    max_active_tasks: Optional[conint(strict=True, ge=0)] = Field(None, alias="maxActiveTasks")
    ...
    __properties = ["catchup", "cellPositions", "concurrency", "dagRunTimeoutSeconds", "defaultArgs", "description", "imports", "isPausedUponCreation", "maxActiveRuns", "maxActiveTasks", "name", "params", "scheduleInterval", "startDate", "tags", "timezone"]
    ...
    def from_dict(cls, obj: dict) -> UpdatePipelineRequest:
        ...
        _obj = UpdatePipelineRequest.parse_obj({
            ...
            "default_args": DefaultArgsRequest.from_dict(obj.get("defaultArgs")) if obj.get("defaultArgs") is not None else None,
