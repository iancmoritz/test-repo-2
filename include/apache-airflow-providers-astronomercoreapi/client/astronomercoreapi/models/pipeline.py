...
class Pipeline(BaseModel):
    ...
    dag_run_timeout_seconds: Optional[StrictInt] = Field(None, alias="dagRunTimeoutSeconds")
    ...
    is_paused_upon_creation: Optional[StrictBool] = Field(None, alias="isPausedUponCreation")
    ...
    __properties = ["catchup", "cellPositions", "concurrency", "createdAt", "createdBy", "dagFile", "dagRunTimeoutSeconds", "defaultArgs", "dependencies", "description", "id", "imports", "isPausedUponCreation", "maxActiveRuns", "maxActiveTasks", "name", "organizationId", "params", "projectId", "scheduleInterval", "startDate", "tags", "timezone", "updatedAt", "updatedBy", "workspaceId"]
    ...
    def from_dict(cls, obj: dict) -> Pipeline:
        ...
        _obj = Pipeline.parse_obj({
            ...
            "default_args": DefaultArgs.from_dict(obj.get("defaultArgs")) if obj.get("defaultArgs") is not None else None,
