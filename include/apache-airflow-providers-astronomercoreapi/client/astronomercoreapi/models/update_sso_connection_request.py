...
class UpdateSsoConnectionRequest(BaseModel):
    ...
    idp_initiated_login_enabled: StrictBool = Field(..., alias="idpInitiatedLoginEnabled")
    ...
    __properties = ["configuration", "enabled", "idpInitiatedLoginEnabled", "jitPolicy", "managedDomains"]
