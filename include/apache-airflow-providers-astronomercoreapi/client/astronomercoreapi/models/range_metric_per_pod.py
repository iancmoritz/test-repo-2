...
class RangeMetricPerPod(BaseModel):
    """
    RangeMetricPerPod
    """
    ...
    __properties = ["component", "deploymentId", "end", "pod", "releaseName", "start", "step", "values", "workspaceId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RangeMetricPerPod:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RangeMetricPerPod:
        """Create an instance of RangeMetricPerPod from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RangeMetricPerPod.parse_obj(obj)

        _obj = RangeMetricPerPod.parse_obj({
