...
import astronomer_core_api.sdk.models
from astronomer_core_api.sdk import rest
from astronomer_core_api.sdk.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sdk.models, klass)
