...
class UpdateAzureClusterRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateAzureClusterRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateAzureClusterRequest:
        """Create an instance of UpdateAzureClusterRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateAzureClusterRequest.parse_obj(obj)

        _obj = UpdateAzureClusterRequest.parse_obj(
            {
                ...
                "name": obj.get("name"),
                "node_pools": [
                    UpdateNodePoolRequest.from_dict(_item)
