...
class InternalEdge(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InternalEdge:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InternalEdge:
        """Create an instance of InternalEdge from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InternalEdge.parse_obj(obj)

        _obj = InternalEdge.parse_obj({
