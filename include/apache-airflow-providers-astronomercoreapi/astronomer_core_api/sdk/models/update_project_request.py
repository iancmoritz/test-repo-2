...
class UpdateProjectRequest(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> UpdateProjectRequest:
        ...
        _obj = UpdateProjectRequest.parse_obj(
            {
                "connections": [
                    UpdateProjectConnectionRequest.from_dict(_item)
                    for _item in obj.get("connections")
                ]
                if obj.get("connections") is not None
                else None,
                "description": obj.get("description"),
                "git": UpdateProjectGitRequest.from_dict(obj.get("git"))
                if obj.get("git") is not None
                else None,
                "includes": [
                    UpdateProjectIncludeRequest.from_dict(_item)
                    for _item in obj.get("includes")
                ]
                ...
                "variables": [
                    UpdateProjectVariableRequest.from_dict(_item)
                    for _item in obj.get("variables")
                ]
