...
class ProjectGitCommitsPaginated(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProjectGitCommitsPaginated:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProjectGitCommitsPaginated:
        """Create an instance of ProjectGitCommitsPaginated from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProjectGitCommitsPaginated.parse_obj(obj)

        _obj = ProjectGitCommitsPaginated.parse_obj(
            {
                "commits": [
                    ProjectGitCommit.from_dict(_item) for _item in obj.get("commits")
                ]
