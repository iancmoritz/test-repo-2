...
class CtmValue(BaseModel):
    ...
    string_list_map: Optional[Dict[str, conlist(StrictStr)]] = Field(
        None, alias="stringListMap"
    )
    string_map: Optional[Dict[str, StrictStr]] = Field(None, alias="stringMap")
    string_map_list: Optional[conlist(Dict[str, StrictStr])] = Field(
        None, alias="stringMapList"
    )
        ...
        _obj = CtmValue.parse_obj(
            {
                ...
                "duration": CtmValueDuration.from_dict(obj.get("duration"))
                if obj.get("duration") is not None
                else None,
                "file": CtmValueFile.from_dict(obj.get("file"))
                ...
                "table": CtmValueTable.from_dict(obj.get("table"))
