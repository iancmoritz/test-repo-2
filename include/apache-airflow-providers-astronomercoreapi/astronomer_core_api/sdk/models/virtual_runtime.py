...
class VirtualRuntime(BaseModel):
    ...
    requirements_validate_status: Optional[StrictStr] = Field(
        None, alias="requirementsValidateStatus"
    )
    ...
    web_server_ingress_hostname: Optional[StrictStr] = Field(
        None, alias="webServerIngressHostname"
    )
