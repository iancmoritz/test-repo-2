...
class DagRunsPaginated(BaseModel):
    """
    DagRunsPaginated
    """

    dag_runs: conlist(DagRun) = Field(..., alias="dagRuns")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DagRunsPaginated:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DagRunsPaginated:
        """Create an instance of DagRunsPaginated from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DagRunsPaginated.parse_obj(obj)

        _obj = DagRunsPaginated.parse_obj(
            {
