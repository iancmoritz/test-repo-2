...
class CtmValueFile(BaseModel):
    ...
    __properties = ["connId", "fileType", "path"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CtmValueFile:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CtmValueFile:
        """Create an instance of CtmValueFile from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CtmValueFile.parse_obj(obj)

        _obj = CtmValueFile.parse_obj({
