...
class CreateCellRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateCellRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateCellRequest:
        """Create an instance of CreateCellRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateCellRequest.parse_obj(obj)

        _obj = CreateCellRequest.parse_obj({
