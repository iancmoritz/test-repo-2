...
class InstantMetricPerComponentStatus(BaseModel):
    """
    ...
    __properties = ["component", "deploymentId", "releaseName", "status", "value", "workspaceId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InstantMetricPerComponentStatus:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InstantMetricPerComponentStatus:
        """Create an instance of InstantMetricPerComponentStatus from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InstantMetricPerComponentStatus.parse_obj(obj)

        _obj = InstantMetricPerComponentStatus.parse_obj({
