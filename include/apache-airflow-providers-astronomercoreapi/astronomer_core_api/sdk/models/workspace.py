...
class Workspace(BaseModel):
    ...
    api_key_only_deployments_default: StrictBool = Field(
        ..., alias="apiKeyOnlyDeploymentsDefault"
    )
    ...
    serverless_runtime_count: Optional[StrictInt] = Field(
        None, alias="serverlessRuntimeCount"
    )
    ...
    def from_dict(cls, obj: dict) -> Workspace:
        ...
        _obj = Workspace.parse_obj(
            {
                "api_key_only_deployments_default": obj.get(
                    "apiKeyOnlyDeploymentsDefault"
                ),
