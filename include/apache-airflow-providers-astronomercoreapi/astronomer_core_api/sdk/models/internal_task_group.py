...
class InternalTaskGroup(BaseModel):
    """
    InternalTaskGroup
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InternalTaskGroup:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InternalTaskGroup:
        """Create an instance of InternalTaskGroup from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InternalTaskGroup.parse_obj(obj)

        _obj = InternalTaskGroup.parse_obj({
            "children": [InternalTaskGroupChildrenInner.from_dict(_item) for _item in obj.get("children")] if obj.get("children") is not None else None,
            "id": obj.get("id"),
