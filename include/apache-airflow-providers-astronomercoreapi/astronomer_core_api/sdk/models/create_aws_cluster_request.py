...
class CreateAwsClusterRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateAwsClusterRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateAwsClusterRequest:
        """Create an instance of CreateAwsClusterRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateAwsClusterRequest.parse_obj(obj)

        _obj = CreateAwsClusterRequest.parse_obj(
            {
