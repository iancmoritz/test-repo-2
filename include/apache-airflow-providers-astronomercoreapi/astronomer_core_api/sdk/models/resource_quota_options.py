...
class ResourceQuotaOptions(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> ResourceQuotaOptions:
        ...
        _obj = ResourceQuotaOptions.parse_obj(
            {
                "default_pod_size": ResourceOption.from_dict(obj.get("defaultPodSize"))
                if obj.get("defaultPodSize") is not None
                else None,
                "resource_quota": ResourceOption.from_dict(obj.get("resourceQuota"))
                if obj.get("resourceQuota") is not None
                else None,
            }
        )
        return _obj
