...
class User(BaseModel):
    ...
    last_login: Optional[StrictStr] = Field(
        None, alias="lastLogin", description="Only shown if admin listing users"
    )
    last_login_connection_name: Optional[StrictStr] = Field(
        None,
        alias="lastLoginConnectionName",
        description="Only shown if admin listing users",
    )
    last_login_connection_type: Optional[StrictStr] = Field(
        None,
        alias="lastLoginConnectionType",
        description="Only shown if admin listing users",
    )
    org_count: Optional[StrictInt] = Field(
        None, alias="orgCount", description="Only shown if admin listing users"
    )
    org_role: Optional[StrictStr] = Field(
        None, alias="orgRole", description="Only shown if listing org users"
    )
    org_user_relation_is_idp_managed: Optional[StrictBool] = Field(
        None,
        alias="orgUserRelationIsIdpManaged",
        description="Only shown if listing org users",
    )
    roles: Optional[conlist(UserRole)] = Field(
        None, description="Only shown if admin listing users"
    )
    status: StrictStr = Field(...)
    system_role: Optional[StrictStr] = Field(
        None, alias="systemRole", description="Only shown if admin listing users"
    )
    updated_at: datetime = Field(..., alias="updatedAt")
    username: StrictStr = Field(...)
    workspace_count: Optional[StrictInt] = Field(
        None, alias="workspaceCount", description="Only shown if admin listing users"
    )
    workspace_role: Optional[StrictStr] = Field(
        None, alias="workspaceRole", description="Only shown if listing workspace users"
    )
    __properties = [
        "avatarUrl",
        "colorModePreference",
        ...
        _obj = User.parse_obj(
            {
                ...
                "org_user_relation_is_idp_managed": obj.get(
                    "orgUserRelationIsIdpManaged"
                ),
