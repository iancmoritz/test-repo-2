...
class UpdateAwsClusterRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateAwsClusterRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateAwsClusterRequest:
        """Create an instance of UpdateAwsClusterRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateAwsClusterRequest.parse_obj(obj)

        _obj = UpdateAwsClusterRequest.parse_obj(
            {
