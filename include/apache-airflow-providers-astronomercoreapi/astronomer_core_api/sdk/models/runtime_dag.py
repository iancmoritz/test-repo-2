...
class RuntimeDag(BaseModel):
    ...
    has_task_concurrency_limits: Optional[StrictBool] = Field(
        None, alias="hasTaskConcurrencyLimits"
    )
    ...
    next_dagrun_create_after: Optional[StrictStr] = Field(
        None, alias="nextDagrunCreateAfter"
    )
    next_dagrun_data_interval_end: Optional[StrictStr] = Field(
        None, alias="nextDagrunDataIntervalEnd"
    )
    next_dagrun_data_interval_start: Optional[StrictStr] = Field(
        None, alias="nextDagrunDataIntervalStart"
    )
    ...
    timetable_description: Optional[StrictStr] = Field(
        None, alias="timetableDescription"
    )
    __properties = [
        "dagId",
        "defaultView",
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RuntimeDag:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RuntimeDag:
        """Create an instance of RuntimeDag from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RuntimeDag.parse_obj(obj)

        _obj = RuntimeDag.parse_obj(
            {
                ...
                "next_dagrun_data_interval_start": obj.get(
                    "nextDagrunDataIntervalStart"
                ),
                ...
                "tags": [DagTag.from_dict(_item) for _item in obj.get("tags")]
