...
class ClusterOptions(BaseModel):
    ...
    database_instances: conlist(ProviderInstanceType) = Field(
        ..., alias="databaseInstances"
    )
    default_database_instance: ProviderInstanceType = Field(
        ..., alias="defaultDatabaseInstance"
    )
    default_node_instance: ProviderInstanceType = Field(
        ..., alias="defaultNodeInstance"
    )
    default_pod_subnet_range: Optional[StrictStr] = Field(
        None, alias="defaultPodSubnetRange"
    )
    default_region: ProviderRegion = Field(..., alias="defaultRegion")
    default_service_peering_range: Optional[StrictStr] = Field(
        None, alias="defaultServicePeeringRange"
    )
    default_service_subnet_range: Optional[StrictStr] = Field(
        None, alias="defaultServiceSubnetRange"
    )
    ...
    def from_dict(cls, obj: dict) -> ClusterOptions:
        ...
        _obj = ClusterOptions.parse_obj(
            {
                "database_instances": [
                    ProviderInstanceType.from_dict(_item)
                    for _item in obj.get("databaseInstances")
                ]
                if obj.get("databaseInstances") is not None
                else None,
                "default_database_instance": ProviderInstanceType.from_dict(
                    obj.get("defaultDatabaseInstance")
                )
                if obj.get("defaultDatabaseInstance") is not None
                else None,
                "default_node_instance": ProviderInstanceType.from_dict(
                    obj.get("defaultNodeInstance")
                )
                if obj.get("defaultNodeInstance") is not None
                else None,
                "default_pod_subnet_range": obj.get("defaultPodSubnetRange"),
                "default_region": ProviderRegion.from_dict(obj.get("defaultRegion"))
                if obj.get("defaultRegion") is not None
                else None,
                ...
                "node_instances": [
                    ProviderInstanceType.from_dict(_item)
                    for _item in obj.get("nodeInstances")
                ]
                if obj.get("nodeInstances") is not None
                else None,
                "provider": obj.get("provider"),
                "regions": [
                    ProviderRegion.from_dict(_item) for _item in obj.get("regions")
                ]
                if obj.get("regions") is not None
                else None,
                "template_versions": [
                    TemplateVersion.from_dict(_item)
                    for _item in obj.get("templateVersions")
                ]
                if obj.get("templateVersions") is not None
                else None,
            }
        )
        return _obj
