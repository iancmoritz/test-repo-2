...
class CreateDagRunRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateDagRunRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateDagRunRequest:
        """Create an instance of CreateDagRunRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateDagRunRequest.parse_obj(obj)

        _obj = CreateDagRunRequest.parse_obj({
