...
class CreateNodePoolRequest(BaseModel):
    ...
    __properties = ["isDefault", "maxNodeCount", "name", "nodeInstanceType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateNodePoolRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateNodePoolRequest:
        """Create an instance of CreateNodePoolRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateNodePoolRequest.parse_obj(obj)

        _obj = CreateNodePoolRequest.parse_obj({
