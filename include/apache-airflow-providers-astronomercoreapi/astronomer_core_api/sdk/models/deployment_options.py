...
class DeploymentOptions(BaseModel):
    ...
    scheduler_machines: conlist(SchedulerMachine) = Field(
        ..., alias="schedulerMachines"
    )
        ...
        _obj = DeploymentOptions.parse_obj(
            {
                ...
                "resource_quotas": ResourceQuotaOptions.from_dict(
                    obj.get("resourceQuotas")
                )
                if obj.get("resourceQuotas") is not None
                else None,
                "runtime_releases": [
                    RuntimeRelease.from_dict(_item)
                    for _item in obj.get("runtimeReleases")
                ]
                if obj.get("runtimeReleases") is not None
                else None,
                "scheduler_machines": [
                    SchedulerMachine.from_dict(_item)
                    for _item in obj.get("schedulerMachines")
                ]
                if obj.get("schedulerMachines") is not None
                else None,
                "worker_machines": [
                    WorkerMachine.from_dict(_item)
                    for _item in obj.get("workerMachines")
                ]
                if obj.get("workerMachines") is not None
                else None,
                "worker_queues": WorkerQueueOptions.from_dict(obj.get("workerQueues"))
