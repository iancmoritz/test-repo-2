...
class ClusterMetadata(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ClusterMetadata:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ClusterMetadata:
        """Create an instance of ClusterMetadata from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ClusterMetadata.parse_obj(obj)

        _obj = ClusterMetadata.parse_obj({
