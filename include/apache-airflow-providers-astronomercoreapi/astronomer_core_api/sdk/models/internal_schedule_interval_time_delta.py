...
class InternalScheduleIntervalTimeDelta(BaseModel):
    """
    ...
    __properties = ["days", "microseconds", "seconds"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InternalScheduleIntervalTimeDelta:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InternalScheduleIntervalTimeDelta:
        """Create an instance of InternalScheduleIntervalTimeDelta from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InternalScheduleIntervalTimeDelta.parse_obj(obj)

        _obj = InternalScheduleIntervalTimeDelta.parse_obj({
            "days": obj.get("days"),
