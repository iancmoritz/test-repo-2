...
class DeploymentApi(object):
    ...
    def create_deployment(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the create_deployment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.create_deployment_with_http_info(
    ...
    def create_deployment_with_http_info(
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            "/organizations/{organizationId}/workspaces/{workspaceId}/deployments",
            "POST",
            _path_params,
            _query_params,
            _header_params,
    ...
    def get_deployment_dag_runs(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_deployment_dag_runs_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.get_deployment_dag_runs_with_http_info(
            organization_id,
            deployment_id,
            dag_id,
            page_size,
    ...
    def get_deployment_dag_runs_with_http_info(
        ...
        **kwargs
        ...
        if _params.get("logical_date__lt") is not None:  # noqa: E501
            if isinstance(_params["logical_date__lt"], datetime):
                _query_params.append(
                    (
                        "logicalDate__lt",
                        _params["logical_date__lt"].strftime(
        ...
        if _params.get("logical_date__gt") is not None:  # noqa: E501
            if isinstance(_params["logical_date__gt"], datetime):
                _query_params.append(
                    (
                        "logicalDate__gt",
                        _params["logical_date__gt"].strftime(
                            self.api_client.configuration.datetime_format
                        ),
                    )
                )
        ...
        if _params.get("start_date__lt") is not None:  # noqa: E501
            if isinstance(_params["start_date__lt"], datetime):
                _query_params.append(
                    (
                        "startDate__lt",
                        _params["start_date__lt"].strftime(
                            self.api_client.configuration.datetime_format
                        ),
                    )
                )
        ...
        if _params.get("start_date__gt") is not None:  # noqa: E501
            if isinstance(_params["start_date__gt"], datetime):
                _query_params.append(
                    (
                        "startDate__gt",
                        _params["start_date__gt"].strftime(
                            self.api_client.configuration.datetime_format
                        ),
                    )
                )
        ...
        return self.api_client.call_api(
            "/organizations/{organizationId}/deployments/{deploymentId}/dags/{dagId}/runs",
            "GET",
            _path_params,
            _query_params,
            _header_params,
    ...
    def get_deployment_dag_structure(
        ...
        **kwargs
    ) -> InternalDagStructure:  # noqa: E501
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_deployment_dag_structure_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.get_deployment_dag_structure_with_http_info(
            organization_id, deployment_id, dag_id, **kwargs
        )  # noqa: E501
    ...
    def get_deployment_dag_structure_with_http_info(
        ...
        **kwargs
        ...
        _all_params = ["organization_id", "deployment_id", "dag_id"]
        _all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
        ...
        return self.api_client.call_api(
            "/organizations/{organizationId}/deployments/{deploymentId}/dags/{dagId}/structure",
            "GET",
            _path_params,
            _query_params,
            _header_params,
    ...
    def get_deployment_health(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_deployment_health_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.get_deployment_health_with_http_info(
            organization_id, deployment_id, **kwargs
        )  # noqa: E501

    @validate_arguments
    def get_deployment_health_with_http_info(
        self,
        organization_id: Annotated[
            StrictStr, Field(..., description="organization ID")
        ],
    ...
    def get_deployment_logs(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_deployment_logs_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.get_deployment_logs_with_http_info(
            organization_id,
            deployment_id,
            sources,
            limit,
    ...
    @validate_arguments
    def get_deployment_logs_with_http_info(
        self,
        organization_id: Annotated[
            StrictStr, Field(..., description="organization ID")
        ],
    ...
    def list_deployments(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the list_deployments_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.list_deployments_with_http_info(
            organization_id,
            deployment_ids,
            workspace_ids,
            offset,
    ...
    def update_deployment(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the update_deployment_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.update_deployment_with_http_info(
            organization_id, workspace_id, deployment_id, body, **kwargs
        )  # noqa: E501

    @validate_arguments
    def update_deployment_with_http_info(
        self,
        organization_id: Annotated[
            StrictStr, Field(..., description="organization ID")
        ],
        ...
        **kwargs
        ...
        _all_params = ["organization_id", "workspace_id", "deployment_id", "body"]
        _all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
        ...
        return self.api_client.call_api(
            "/organizations/{organizationId}/workspaces/{workspaceId}/deployments/{deploymentId}",
            "POST",
            _path_params,
            _query_params,
            _header_params,
