...
class ClusterApi(object):
    ...
    def create_aws_cluster(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the create_aws_cluster_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.create_aws_cluster_with_http_info(
            organization_id, body, **kwargs
        )  # noqa: E501

    @validate_arguments
    def create_aws_cluster_with_http_info(
        self,
        organization_id: Annotated[
            StrictStr, Field(..., description="organization ID")
        ],
    ...
    def create_azure_cluster(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the create_azure_cluster_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.create_azure_cluster_with_http_info(
            organization_id, body, **kwargs
        )  # noqa: E501

    @validate_arguments
    def create_azure_cluster_with_http_info(
        self,
        organization_id: Annotated[
            StrictStr, Field(..., description="organization ID")
        ],
    ...
    def create_gcp_cluster(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the create_gcp_cluster_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.create_gcp_cluster_with_http_info(
            organization_id, body, **kwargs
        )  # noqa: E501

    @validate_arguments
    def create_gcp_cluster_with_http_info(
        self,
        organization_id: Annotated[
            StrictStr, Field(..., description="organization ID")
        ],
    ...
    def delete_cluster(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the delete_cluster_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.delete_cluster_with_http_info(
            organization_id, cluster_id, **kwargs
        )  # noqa: E501
    ...
    def delete_cluster_with_http_info(
        ...
        **kwargs
        ...
        _all_params = ["organization_id", "cluster_id"]
        _all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
    ...
    def get_shared_cluster(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_shared_cluster_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.get_shared_cluster_with_http_info(
            region, cloud_provider, **kwargs
        )  # noqa: E501

    @validate_arguments
    def get_shared_cluster_with_http_info(
        self,
        region: Annotated[StrictStr, Field(..., description="region")],
        cloud_provider: Annotated[StrictStr, Field(..., description="cloud provider")],
        **kwargs
        ...
        _all_params = ["region", "cloud_provider"]
        _all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
    ...
    def update_aws_cluster(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the update_aws_cluster_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.update_aws_cluster_with_http_info(
            organization_id, cluster_id, body, **kwargs
        )  # noqa: E501

    @validate_arguments
    def update_aws_cluster_with_http_info(
        self,
        organization_id: Annotated[
            StrictStr, Field(..., description="organization ID")
        ],
        ...
        **kwargs
        ...
        _all_params = ["organization_id", "cluster_id", "body"]
        _all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
    ...
    def update_azure_cluster(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the update_azure_cluster_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.update_azure_cluster_with_http_info(
            organization_id, cluster_id, body, **kwargs
        )  # noqa: E501

    @validate_arguments
    def update_azure_cluster_with_http_info(
        self,
        organization_id: Annotated[
            StrictStr, Field(..., description="organization ID")
        ],
    ...
    def update_gcp_cluster(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the update_gcp_cluster_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.update_gcp_cluster_with_http_info(
            organization_id, cluster_id, body, **kwargs
        )  # noqa: E501

    @validate_arguments
    def update_gcp_cluster_with_http_info(
        self,
        organization_id: Annotated[
            StrictStr, Field(..., description="organization ID")
        ],
