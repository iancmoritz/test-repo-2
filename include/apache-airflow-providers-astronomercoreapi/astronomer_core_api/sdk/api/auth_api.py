...
class AuthApi(object):
    ...
    def validate_sso_bypass_key(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the validate_sso_bypass_key_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.validate_sso_bypass_key_with_http_info(
            sso_bypass_key, **kwargs
        )  # noqa: E501

    @validate_arguments
    def validate_sso_bypass_key_with_http_info(
        self,
        sso_bypass_key: Annotated[
            StrictStr, Field(..., description="SSO bypass key for organization")
        ],
        **kwargs
        ...
        return self.api_client.call_api(
            "/auth/sso-bypass-keys/{ssoBypassKey}",
            "GET",
            _path_params,
            _query_params,
            _header_params,
