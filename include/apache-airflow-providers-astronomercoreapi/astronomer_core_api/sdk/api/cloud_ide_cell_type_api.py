...
class CloudIDECellTypeApi(object):
    ...
    def create_cell_type(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the create_cell_type_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.create_cell_type_with_http_info(
            organization_id, workspace_id, project_id, data, **kwargs
        )  # noqa: E501

    @validate_arguments
    def create_cell_type_with_http_info(
        self,
        organization_id: Annotated[
            StrictStr, Field(..., description="organization ID")
        ],
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            "/organizations/{organizationId}/workspaces/{workspaceId}/projects/{projectId}/cell-types",
            "POST",
            _path_params,
            _query_params,
            _header_params,
    ...
    def delete_cell_type(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the delete_cell_type_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.delete_cell_type_with_http_info(
            organization_id, workspace_id, project_id, cell_type_name, **kwargs
        )  # noqa: E501
    ...
    def delete_cell_type_with_http_info(
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            "/organizations/{organizationId}/workspaces/{workspaceId}/projects/{projectId}/cell-types/{cellTypeName}",
            "DELETE",
            _path_params,
            _query_params,
            _header_params,
    ...
    def get_cell_type(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_cell_type_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.get_cell_type_with_http_info(
            organization_id, workspace_id, project_id, cell_type_name, **kwargs
        )  # noqa: E501

    @validate_arguments
    def get_cell_type_with_http_info(
        self,
        organization_id: Annotated[
            StrictStr, Field(..., description="organization ID")
        ],
    ...
    def list_cell_types(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the list_cell_types_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.list_cell_types_with_http_info(
            organization_id, workspace_id, project_id, names, **kwargs
        )  # noqa: E501

    @validate_arguments
    def list_cell_types_with_http_info(
        self,
        organization_id: Annotated[
            StrictStr, Field(..., description="organization ID")
        ],
        ...
        **kwargs
        ...
        _all_params = ["organization_id", "workspace_id", "project_id", "names"]
        _all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
    ...
    def update_cell_type(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the update_cell_type_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.update_cell_type_with_http_info(
            organization_id, workspace_id, project_id, cell_type_name, data, **kwargs
        )  # noqa: E501

    @validate_arguments
    def update_cell_type_with_http_info(
        self,
        organization_id: Annotated[
            StrictStr, Field(..., description="organization ID")
        ],
    ...
    def validate_cell_type(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the validate_cell_type_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.validate_cell_type_with_http_info(
            organization_id, workspace_id, project_id, data, **kwargs
        )  # noqa: E501

    @validate_arguments
    def validate_cell_type_with_http_info(
        self,
        organization_id: Annotated[
            StrictStr, Field(..., description="organization ID")
        ],
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            "/organizations/{organizationId}/workspaces/{workspaceId}/projects/{projectId}/validate-cell-type",
            "POST",
            _path_params,
            _query_params,
            _header_params,
