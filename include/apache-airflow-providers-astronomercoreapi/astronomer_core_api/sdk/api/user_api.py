...
class UserApi(object):
    ...
    def delete_org_user(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the delete_org_user_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.delete_org_user_with_http_info(
            organization_id, user_id, **kwargs
        )  # noqa: E501

    @validate_arguments
    def delete_org_user_with_http_info(
        self,
        organization_id: Annotated[
            StrictStr, Field(..., description="organization ID")
        ],
        ...
        **kwargs
        ...
        _all_params = ["organization_id", "user_id"]
        _all_params.extend(
            [
                "async_req",
    ...
    def delete_workspace_user(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the delete_workspace_user_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.delete_workspace_user_with_http_info(
            organization_id, workspace_id, user_id, **kwargs
        )  # noqa: E501
    ...
    def delete_workspace_user_with_http_info(
        ...
        **kwargs
        ...
        _all_params = ["organization_id", "workspace_id", "user_id"]
        _all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
    ...
    def get_self_user(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_self_user_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.get_self_user_with_http_info(
            create_if_not_exist, **kwargs
        )  # noqa: E501

    @validate_arguments
    def get_self_user_with_http_info(
        self,
        create_if_not_exist: Annotated[
            Optional[StrictBool],
            Field(description="create self user if it does not already exist"),
        ...
        **kwargs
        ...
        _all_params = ["create_if_not_exist"]
        _all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
    ...
    def get_user(
        ...
        **kwargs
        ...
        return self.get_user_with_http_info(
            organization_id, user_id, **kwargs
        )  # noqa: E501
    ...
    def list_org_users(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the list_org_users_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.list_org_users_with_http_info(
            organization_id, offset, limit, sorts, search, has_invites, **kwargs
        )  # noqa: E501

    @validate_arguments
    def list_org_users_with_http_info(
        self,
        organization_id: Annotated[
            StrictStr, Field(..., description="organization ID")
        ],
    ...
    def list_workspace_users(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the list_workspace_users_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.list_workspace_users_with_http_info(
    ...
    def mutate_org_user_role(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the mutate_org_user_role_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.mutate_org_user_role_with_http_info(
            organization_id, user_id, body, **kwargs
        )  # noqa: E501

    @validate_arguments
    def mutate_org_user_role_with_http_info(
        self,
        organization_id: Annotated[
            StrictStr, Field(..., description="organization ID")
        ],
        ...
        **kwargs
        ...
        _all_params = ["organization_id", "user_id", "body"]
        _all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
    ...
    def mutate_workspace_user_role(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the mutate_workspace_user_role_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.mutate_workspace_user_role_with_http_info(
            organization_id, workspace_id, user_id, body, **kwargs
        )  # noqa: E501
    ...
    def mutate_workspace_user_role_with_http_info(
        ...
        **kwargs
        ...
        _all_params = ["organization_id", "workspace_id", "user_id", "body"]
        _all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
