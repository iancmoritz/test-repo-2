...
class CloudIDECellApi(object):
    ...
    def create_cell(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the create_cell_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.create_cell_with_http_info(
            organization_id, workspace_id, project_id, pipeline_id, data, **kwargs
        )  # noqa: E501

    @validate_arguments
    def create_cell_with_http_info(
        self,
        organization_id: Annotated[
            StrictStr, Field(..., description="organization ID")
        ],
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            "/organizations/{organizationId}/workspaces/{workspaceId}/projects/{projectId}/pipelines/{pipelineId}/cells",
            "POST",
            _path_params,
            _query_params,
            _header_params,
    ...
    def delete_cell(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the delete_cell_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.delete_cell_with_http_info(
            organization_id, workspace_id, project_id, pipeline_id, cell_id, **kwargs
        )  # noqa: E501

    @validate_arguments
    def delete_cell_with_http_info(
        self,
        organization_id: Annotated[
            StrictStr, Field(..., description="organization ID")
        ],
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            "/organizations/{organizationId}/workspaces/{workspaceId}/projects/{projectId}/pipelines/{pipelineId}/cells/{cellId}",
            "DELETE",
            _path_params,
            _query_params,
            _header_params,
    ...
    def duplicate_cell(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the duplicate_cell_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.duplicate_cell_with_http_info(
            organization_id,
            workspace_id,
            project_id,
            pipeline_id,
    ...
    @validate_arguments
    def duplicate_cell_with_http_info(
        self,
        organization_id: Annotated[
            StrictStr, Field(..., description="organization ID")
        ],
        ...
        **kwargs
        ...
        return self.api_client.call_api(
            "/organizations/{organizationId}/workspaces/{workspaceId}/projects/{projectId}/pipelines/{pipelineId}/cells/{cellId}/duplicate",
            "POST",
            _path_params,
            _query_params,
            _header_params,
    ...
    def get_cell(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the get_cell_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.get_cell_with_http_info(
            organization_id, workspace_id, project_id, pipeline_id, cell_id, **kwargs
        )  # noqa: E501

    @validate_arguments
    def get_cell_with_http_info(
        self,
        organization_id: Annotated[
            StrictStr, Field(..., description="organization ID")
        ],
    ...
    def list_cells(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the list_cells_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.list_cells_with_http_info(
            organization_id,
            workspace_id,
            project_id,
            pipeline_id,
    ...
    def update_cell(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the update_cell_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.update_cell_with_http_info(
            organization_id,
            workspace_id,
            project_id,
            pipeline_id,
    ...
    @validate_arguments
    def update_cell_with_http_info(
        self,
        organization_id: Annotated[
            StrictStr, Field(..., description="organization ID")
        ],
