    ...
    def has_permissions(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            raise ValueError(
                "Error! Please call the has_permissions_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            )
        return self.has_permissions_with_http_info(body, **kwargs)  # noqa: E501

    @validate_arguments
    def has_permissions_with_http_info(
        self,
        body: Annotated[
            HasPermissionsRequest,
            Field(..., description="request body for get permissions"),
