...
class RelatedModuleRequest(BaseModel):
    """
    ...
    __properties = ["moduleName", "providerName", "version"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RelatedModuleRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RelatedModuleRequest:
        """Create an instance of RelatedModuleRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RelatedModuleRequest.parse_obj(obj)

        _obj = RelatedModuleRequest.parse_obj({
