...
class ModuleInheritsFrom(BaseModel):
    """
    ModuleInheritsFrom
    """
    module_name: Optional[StrictStr] = Field(None, alias="moduleName")
    ...
    __properties = ["moduleName", "organizationId", "providerName", "version"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModuleInheritsFrom:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModuleInheritsFrom:
        """Create an instance of ModuleInheritsFrom from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ModuleInheritsFrom.parse_obj(obj)

        _obj = ModuleInheritsFrom.parse_obj({
