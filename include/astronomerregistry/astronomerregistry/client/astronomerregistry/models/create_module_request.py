...
class CreateModuleRequest(BaseModel):
    ...
    parameters: Optional[conlist(CreateModuleParameterRequest)] = None
    social_stats: Optional[SocialStats] = Field(None, alias="socialStats")
    type: StrictStr = Field(...)
    __properties = ["description", "displayName", "documentation", "githubUrl", "importPath", "inheritsFrom", "isCertified", "isCloudIDECompatible", "isDisplayNameManual", "isFeatured", "isGlobal", "isLogoManual", "isPrivate", "labels", "logo", "name", "parameters", "socialStats", "type"]
    ...
    def from_dict(cls, obj: dict) -> CreateModuleRequest:
        ...
        _obj = CreateModuleRequest.parse_obj({
            ...
            "logo": obj.get("logo"),
            "name": obj.get("name"),
            "parameters": [CreateModuleParameterRequest.from_dict(_item) for _item in obj.get("parameters")] if obj.get("parameters") is not None else None,
