...
class Module(BaseModel):
    ...
    parameters: conlist(ModuleParameter) = Field(...)
    provider_display_name: StrictStr = Field(..., alias="providerDisplayName")
    ...
    __properties = ["badges", "categories", "createdAt", "createdBy", "description", "displayName", "documentation", "githubUrl", "importPath", "isCertified", "isCloudIDECompatible", "isDisplayNameManual", "isFeatured", "isGlobal", "isLatestVersion", "isLogoManual", "isPrivate", "logo", "name", "organizationId", "otherVersions", "parameters", "providerDisplayName", "providerName", "searchId", "searchRank", "shortNameId", "socialStats", "tiers", "type", "updatedAt", "updatedBy", "version"]
    ...
    def from_dict(cls, obj: dict) -> Module:
        ...
        _obj = Module.parse_obj({
            ...
            "parameters": [ModuleParameter.from_dict(_item) for _item in obj.get("parameters")] if obj.get("parameters") is not None else None,
            "provider_display_name": obj.get("providerDisplayName"),
