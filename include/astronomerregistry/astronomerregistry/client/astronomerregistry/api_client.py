...
import astronomerregistry.models
from astronomerregistry import rest
from astronomerregistry.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(astronomerregistry.models, klass)
