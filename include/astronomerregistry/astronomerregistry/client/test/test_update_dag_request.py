...
from astronomerregistry.models.update_dag_request import UpdateDagRequest  # noqa: E501
from astronomerregistry.rest import ApiException

class TestUpdateDagRequest(unittest.TestCase):
    """UpdateDagRequest unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test UpdateDagRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateDagRequest`
        """
        model = astronomerregistry.models.update_dag_request.UpdateDagRequest()  # noqa: E501
        if include_optional :
            return UpdateDagRequest(
                description = '', 
                display_name = '', 
                documentation = '', 
                file_path = '', 
