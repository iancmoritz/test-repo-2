...
class CreateLabelRequest(BaseModel):
    ...
    __properties = ["description", "graphics", "isPrivate", "name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateLabelRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateLabelRequest:
        """Create an instance of CreateLabelRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateLabelRequest.parse_obj(obj)

        _obj = CreateLabelRequest.parse_obj({
