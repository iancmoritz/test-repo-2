...
class ProviderFilters(BaseModel):
    ...
    __properties = ["badges", "categories", "tiers"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProviderFilters:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProviderFilters:
        """Create an instance of ProviderFilters from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProviderFilters.parse_obj(obj)

        _obj = ProviderFilters.parse_obj({
