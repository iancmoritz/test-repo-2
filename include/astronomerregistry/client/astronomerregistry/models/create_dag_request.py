...
class CreateDagRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateDagRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateDagRequest:
        """Create an instance of CreateDagRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateDagRequest.parse_obj(obj)

        _obj = CreateDagRequest.parse_obj({
