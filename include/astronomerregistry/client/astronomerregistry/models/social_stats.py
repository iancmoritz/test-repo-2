...
class SocialStats(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SocialStats:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SocialStats:
        """Create an instance of SocialStats from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SocialStats.parse_obj(obj)

        _obj = SocialStats.parse_obj({
            "stars": obj.get("stars"),
            "views": obj.get("views")
        })
        return _obj
