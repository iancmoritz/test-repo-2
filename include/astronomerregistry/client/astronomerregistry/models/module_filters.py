...
class ModuleFilters(BaseModel):
    ...
    __properties = ["badges", "categories", "providers", "tiers"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModuleFilters:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModuleFilters:
        """Create an instance of ModuleFilters from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ModuleFilters.parse_obj(obj)

        _obj = ModuleFilters.parse_obj({
