...
class UpdateProviderRequest(BaseModel):
    ...
    __properties = ["description", "displayName", "docsUrl", "githubUrl", "isCertified", "isCloudIDECompatible", "isDisplayNameManual", "isFeatured", "isGlobal", "isLogoManual", "isPrivate", "labels", "logo", "socialStats", "type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateProviderRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateProviderRequest:
        """Create an instance of UpdateProviderRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateProviderRequest.parse_obj(obj)

        _obj = UpdateProviderRequest.parse_obj({
