...
class CreateModuleParameterRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateModuleParameterRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateModuleParameterRequest:
        """Create an instance of CreateModuleParameterRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateModuleParameterRequest.parse_obj(obj)

        _obj = CreateModuleParameterRequest.parse_obj({
